<template>
		<!--container-->
		<div class="container">
			<form name="channelForm" id="channelForm" method="post" v-on:submit.prevent="runSubmit">
			...
			<div class="content">
				<div class="content_inner">
                    ...
                    <div class="btn_area">
                        <a href="/channel"class="btn_large_type02" id="cancel-insert">취소하기</a>
...
// 			}
			...
			if(confirm('채널을 등록 하시겠습니까?')) {
				...
				axios.post(API_URL+"/channel/insertJson.dat", data)
				.then(() => {
		...
		checkUseCode() {
			...
			axios.post(API_URL+"/channel/channel_one.dat", {code: paramCode}, {
				headers: {
