                ...
                <div class="content_inner">
                    <div class="tit_area">
                        ...
                        <span class="tit_btn_area">
                            <a href="/member/insert.do" class="btn_mid_type01" id="btn-reg-cont">사용자등록</a>
...
<!--                                 <li><a href="#none" class="next-last"></a></li> -->
        ...
        <!--// container-->
        <form name="modiForm" id="modiForm" method="post" action="/member/modify.do">
...
createApp({
	...
	methods: {
		...
		async getMemberList(page=1) {
			...
			try {
				const response = await axios.get('/member/list.dat', {params: {start: this.start, limit: this.limit}});
...
// 				addEvent(page);
		...
		async getMemberTotalCount() {
			try {
				const response = await axios.get('/member/total_cnt.dat');
