...
<body>
	<div class="wrapper" id="v-app">
		...
		<!--container-->
		<div class="container">
			<form name="channelForm" id="channelForm" method="post" action="/channel/update.dat" >
...
createApp({
	...
	mounted: function () {
		...
		axios.post('/channel/channel_one.dat', {code: '${channel.code}'})
		.then(response => {
			if (response.data.ia_tabs != null) this.ia_tabs = response.data.ia_tabs;
		})
		.catch(error => {
			console.log(error)
		});
...
// 			}
			...
			if(confirm('수정 하시겠습니까?')) {
				...
				axios.post("/channel/updateJson.dat", data)
